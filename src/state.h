// Copyright (c) 2014 The VibranChainopers
...
const int64_t GENESIS_BLOCK_TIME = 1533298099;

static const int64_t COIN = 10000000;
static const int64_t CENT = 100000;
...
static const int64_t COIN_YEAR_REWARD = 0 * CENT; // 2% per year
