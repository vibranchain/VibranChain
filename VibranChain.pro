...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.VibranChain
    BOOST_LIB_SUFFIX=-mt
...
OPENSSL_INCLUDE_PATH=C:/deps/openssl-1.0.11/include
OPENSSL_LIB_PATH=C:/deps/openssl-1.0.11
...
# also add new translations to VibranChain.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/local*.ts)
...
macx:ICON = src/qt/res/icons/VibranChain.icns
macx:TARGET = "VibranChain"
